document.addEventListener('DOMContentLoaded', () => {
        ...
        if (cartTable) {
            cartTable.innerHTML = cart.map((item, index) => `
                <tr>
                    ...
                    <td>${item.price}</td>
                    <td>
                        <input type="number" class="form-control update-quantity" data-index="${index}" value="${item.quantity}">
                    </td>
                    <td>
    ...
    document.getElementById('cart-table').addEventListener('input', (event) => {
